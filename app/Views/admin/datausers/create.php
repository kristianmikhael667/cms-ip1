                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box d-flex align-items-center justify-content-between">
                                <h4 class="mb-0 font-size-18"><i class="mdi mdi-account-multiple-plus"></i> Form Create User</h4>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="card">
                                <div class="card-body">
                                    <div class="container">
                                        <form action="<?= base_url('/admin/store_user') ?>" method="POST" enctype="multipart/form-data">
                                            <?= csrf_field(); ?>
                                            ...
                                            <div class="row">
                                                <div class="col-5 mr-3">
                                                    ...
                                                    <div class="row mb-3">
                                                        ...
                                                        <select name="id_customer" class="custom-select <?= ($validation->hasError('id_customer')) ? 'is-invalid' : ''; ?>">
                                                            <option disabled selected>Open this select menu</option>
                                                            <?php foreach ($customers as $customer) : ?>
                                                                <option value="<?= $customer->id_customer ?>"><?= $customer->username ?></option>
                                                            <?php endforeach; ?>
                                                        </select>
                                                        <div class="invalid-feedback">
                                                            <?= $validation->getError('id_customer'); ?>
                                                        </div>
                                                    </div>
